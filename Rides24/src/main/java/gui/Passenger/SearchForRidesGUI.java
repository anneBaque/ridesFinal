		...
		btnReservar.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e) {
				...
				if (selectedRow ==-1) {
					...
					if(pasajero.getWallet().calcularSaldo()>=selectedRide.getPrice()) {
						if(!facade.existsReservation(res)) {
							facade.makeReservation(res);
							facade.pay(pasajero, selectedRide.getPrice());
							
							//Noti//
							String asunto = ResourceBundle.getBundle("Etiquetas").getString("SearchGUI.Asunto");
							String mensaje1 = ResourceBundle.getBundle("Etiquetas").getString("SearchGUI.Mensaje1");
							String mensaje2 = ResourceBundle.getBundle("Etiquetas").getString("SearchGUI.Mensaje2");
							Mail mensaje = new Mail(selectedRide.getDriver().getEmail(), pasajero.getEmail(), asunto, mensaje1 +" "+selectedRide.getRideNumber()+" "+mensaje2+" "+ pasajero.getEmail());
						...
						JOptionPane.showMessageDialog(null,  ResourceBundle.getBundle("Etiquetas").getString("FindRidesGUI.NoDinero"));
					}
