...
public class MyReservedRidesGUI extends JFrame {
	 ...
	 * Create the frame.
	 */
	public MyReservedRidesGUI(Passenger pasajero) {
		...
		List<Reservation> lista =facade.getAllReservations(pasajero.getEmail());
